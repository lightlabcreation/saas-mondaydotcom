...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    req.user = {
      ...
      roleId: user.roleId,
      companyId: decoded.user.companyId || user.companyId, // Extract from token or user db
      permissions: mergedPermissions
    };

    req.companyId = req.user.companyId; // Attach for easy access in SaaS controllers
